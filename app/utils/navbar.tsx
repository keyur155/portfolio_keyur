...
export default function NavBar() {
   ...
   function ClickOpenMenu(value: boolean) {
    ...
    return (  
       ...
       <header className="bg-gray-800 text-white p-4">
          ...
          <nav ref={navRef} className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
             <div className="flex lg:flex-1">
               ...
               <div className="flex lg:hidden">
                  <button type="button" onClick={() => ClickOpenMenu(true)} className="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-400">
      ...
      <div className="relative">
        <button type="button" onClick={() => setProductOpen((prev) => !prev)} className="flex items-center gap-x-1 text-sm/6 font-semibold text-white">
          Product
        ...
        <div id="desktop-menu-product" className={`${productOpen ? 'block' : 'hidden'} absolute top-full left-0 mt-2 w-120 overflow-hidden rounded-3xl bg-gray-800 outline-1 -outline-offset-1 outline-white/10 shadow-xl transition`}>
          <div className="p-4">
  ...
  <div className={`fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-900 p-6 sm:max-w-sm sm:ring-1 sm:ring-gray-100/10 transform transition-transform duration-300 ease-in-out lg:hidden ${mobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
    ...
    <div className="mt-6 flow-root">
      <div className="-my-6 divide-y divide-white/10">
        <div className="space-y-2 py-6">
          <div className="-mx-3">
            <button type="button" onClick={() => setProductOpen((prev) => !prev)} className="flex w-full items-center justify-between rounded-lg py-2 pr-3.5 pl-3 text-base/7 font-semibold text-white hover:bg-white/5">
              Product
              <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" className="size-5 flex-none">
                <path d="M5.22 8.22a.75.75 0 0 1 1.06 0L10 11.94l3.72-3.72a.75.75 0 1 1 1.06 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L5.22 9.28a.75.75 0 0 1 0-1.06Z" clipRule="evenodd" fillRule="evenodd" />
              </svg>
            </button>
            <div className={`${productOpen ? 'block' : 'hidden'} mt-2 space-y-2`}>
